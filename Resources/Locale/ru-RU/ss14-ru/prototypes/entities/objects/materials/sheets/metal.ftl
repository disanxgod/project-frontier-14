...
ent-SheetMagmite1 = магмитовая сталь
    .suffix = Один
    .desc = Лист крайне плотной и сложной в производстве магмитовой стали.
ent-SheetAstrolite = астролит
    .suffix = Полный, LuaTech
    .desc = Сплав, созданный из редчайших железо-никелевых метеоритов, в структуре сплава присутствуют кристаллические - образования, нечто непостижимое.
ent-SheetAstrolite10 = астролит
    .suffix = 10, LuaTech
    .desc = { ent-SheetAstrolite.desc }
ent-SheetAstrolite1 = астролит
    .suffix = Один, LuaTech
    .desc = { ent-SheetAstrolite.desc }
